...
/**
 * Result from a connect session
 */
sealed class ConnectSessionResult {
    ...
    /**
     * [ConnectSessionResult] when the connect session failed to start
     */
    object NotStarted : ConnectSessionResult()
}
