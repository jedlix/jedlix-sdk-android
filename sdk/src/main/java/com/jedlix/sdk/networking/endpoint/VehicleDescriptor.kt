...
internal object VehicleDescriptor : EndpointResultDescriptor<Vehicle> {
    override val serializer = Vehicle.serializer()
...
internal object VehicleListDescriptor : EndpointResultDescriptor<List<Vehicle>> {
    override val serializer = ListSerializer(Vehicle.serializer())
    override fun toError(apiException: ApiException): Error? =
        when (apiException.code) {
            HttpStatusCode.Unauthorized.value -> Error.Unauthorized
            HttpStatusCode.Forbidden.value -> Error.Forbidden
...
internal object VehicleDeleteDescriptor : EndpointResultDescriptor<Unit> {
